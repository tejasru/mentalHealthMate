...
public Doctor_payment getDpayment() {
	return dpayment;
}
public void setDpayment(Doctor_payment dpayment) {
	this.dpayment = dpayment;
}
@Override
public String toString() {
	return "Doctor_Appointment [docAppointment_id=" + docAppointment_id + ", patient_name=" + patient_name + ", time="
			+ time + ", uphone=" + uphone + ", visitedStatus=" + visitedStatus + ", dpayment=" + dpayment + "]";
}
